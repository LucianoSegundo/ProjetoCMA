...
public class QuestVack {
	...
	public QuestVack(Questionario questionario) {
		super();
		this.questionario = questionario;
	}

	public QuestVack(VackRequest vack, Questionario questionario) {
		this.preecher(vack);
		this.questionario = questionario;
	...
	public VackResponse toVackResponse() {
		VackResponse response = new VackResponse(this.id, this.visuak, this.auditivo, this.cinestesico,
				this.leituraEscrita, retornarEstilo());

		return response;
	}

	public String retornarEstilo() {
		if (this.auditivo == 0 && this.auditivo == 0 && this.cinestesico == 0 && this.leituraEscrita == 0)
			return "Sem estilo definido";
